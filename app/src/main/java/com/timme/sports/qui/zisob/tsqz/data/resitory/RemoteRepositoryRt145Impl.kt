package com.timme.sports.qui.zisob.tsqz.data.resitory
...
import com.timme.sports.qui.zisob.tsqz.data.mapper.toFootballRt145
...
import com.timme.sports.qui.zisob.tsqz.domain.utils.ANDROID_API_KEY_RT_145
import com.timme.sports.qui.zisob.tsqz.domain.utils.APPLICATION_ID_RT_145
import com.timme.sports.qui.zisob.tsqz.domain.utils.BACK_URL_RT_145
import com.timme.sports.qui.zisob.tsqz.domain.utils.NAME_RT_145
import com.timme.sports.qui.zisob.tsqz.domain.utils.OBJECT_ID_KEY_RT_145
import com.timme.sports.qui.zisob.tsqz.domain.utils.ResourceRt145
import com.timme.sports.qui.zisob.tsqz.domain.utils.SHARED_DATA_RT_145
import com.timme.sports.qui.zisob.tsqz.domain.utils.SHARED_URL_RT_145
import com.timme.sports.qui.zisob.tsqz.domain.utils.TABLE_NAME_RT_145
import com.timme.sports.qui.zisob.tsqz.domain.utils.UNKNOWN_ERROR_RT_145
import javax.inject.Inject
import com.timme.sports.qui.zisob.tsqz.domain.utils.SHARED_IS_FIRST_RT_145
import com.timme.sports.qui.zisob.tsqz.domain.utils.formatDate
...
class RemoteRepositoryRt145Impl @Inject constructor(
    ...
    override suspend fun getFirstRt145(): Boolean = sharedPrefRt137.getBoolean(
        SHARED_IS_FIRST_RT_145, true)
